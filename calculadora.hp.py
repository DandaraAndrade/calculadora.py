...
Data: 02/05/2024
Esta calculadora representa estilo HP em Python, que permita ao usuário escolher entre diferentes operações matemáticas 
(adição, subtração, multiplicação e divisão) e realizar cálculos repetidamente até que ele decida sair utilizando um comando básico.
